...
- **Headings & Numbering:** Filename serves as note title (`H1` `# Title`). Never alter or manually type heading numbers (managed by Obsidian Number Headings plugin); write plain text for new headings.
