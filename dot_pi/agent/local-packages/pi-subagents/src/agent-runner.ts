...
/** Defensive denylist tombstone for the retired model-facing workflow tool. */
export const RETIRED_WORKFLOW_TOOL_NAME = "SubagentWorkflow";

/** Names of tools registered by this extension that subagents must NOT inherit. */
const EXCLUDED_TOOL_NAMES: string[] = [
  ...Object.values(SUBAGENT_TOOL_NAMES),
  RETIRED_WORKFLOW_TOOL_NAME,
];
