...
export const DEFAULT_PROMPT_GUIDELINES: string[] = [
	...
	"When asking `advisor` to inspect particular source code, prose, a diff, or an exact error, include the necessary material in `evidence`; the advisor has no tools and a checkpoint is not a substitute for source evidence.",
