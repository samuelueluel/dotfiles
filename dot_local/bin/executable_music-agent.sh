...
MODEL="${PIHAT_MODEL:-openai-codex/gpt-6-luna}"
SCOPE='openrouter-us/**:max,openrouter-ds/**:max,openai-codex/gpt-6*:max,openrouter-us-max/!(anthropic)/**:max,openrouter-ds-max/**:max'
